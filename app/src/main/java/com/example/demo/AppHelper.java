...
public class AppHelper {
    ...
    public static void selectPicture(Activity context , boolean isSingle,boolean isCrop,int cropWidth,int cropHeight,int requestCode) {
        ...
        PictureSelector.create(context)
                ...
                .glideOverride(165, 165)// glide 加载宽高，越小图片列表越流畅，但会影响列表图片浏览的清晰度
