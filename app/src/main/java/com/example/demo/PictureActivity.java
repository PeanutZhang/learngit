...
import com.example.demo.adapter.GridImageAdapter;
...
public class PictureActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            if(true){AppHelper.selectPicture(PictureActivity.this,cb_choose_mode.isChecked(),cb_crop.isChecked(),0,0,PictureConfig.CHOOSE_REQUEST);return;}
                ...
                case PictureConfig.CHOOSE_REQUEST:
                    ...
                    for (LocalMedia media : selectList) {
                        ...
                        if (media.isCut() && !media.isCompressed()) {
                            ...
                            Bitmap bitmapYuan = BitmapFactory.decodeFile(path2);
                            Bitmap bitmapCompress = BitmapFactory.decodeFile(path);
                            Log.e("图片--压缩过,或者裁剪同时压缩过---》", path+"  "+" 原图 path "+path2);
                            Log.e("图片--》 "," 原图大小 "+bitmapYuan.getByteCount()/1024 +" height: "+bitmapYuan.getHeight() + " width  "+bitmapYuan.getWidth());
                            Log.e("图片--》 "," 压缩大小 "+bitmapCompress.getByteCount()/1024 +" height: "+bitmapCompress.getHeight() + " width  "+bitmapCompress.getWidth());
                        } else {
                            // 原图
                            path = media.getPath();
                            Log.i("原图图片-----》", path);
