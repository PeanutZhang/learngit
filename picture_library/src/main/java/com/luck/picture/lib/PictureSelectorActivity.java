...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    protected void readLocalMedia() {
        mediaLoader.loadAllMedia(new LocalMediaLoader.LocalMediaLoadListener() {
            ...
            public void loadComplete(List<LocalMediaFolder> folders) {
                Log.e("zyh","--loadCompLtet----out misg-> "+ mIsPreview);

                if (folders.size() > 0 && !mIsPreview) {
                    Log.e("zyh","--loadCompLtet----in-> ");
                    foldersList = folders;
    ...
    public void onPictureClick(LocalMedia media, int position) {
        ...
        mIsPreview = true;
        Log.e("zyh","--nPictureClick----in-> "+mIsPreview);
